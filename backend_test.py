...
class CMSBackendTester:
        ...
        for endpoint in endpoints:
            try:
                ...
                self.log_test(
                    ...
                    has_cors,
                    f"CORS headers: {cors_headers}" if has_cors else "Missing CORS headers",
                    cors_headers
                )
            except Exception as e:
                self.log_test(
    ...
    def test_api_structure_and_responses(self):
        ...
        try:
            ...
            self.log_test(
                ...
                json_data if has_json else response.text
            )
    ...
    def test_content_status_enum_validation(self):
        ...
        try:
            ...
            self.log_test(
                "Content Status Enum Validation",
                False,
                f"Request failed: {str(e)}"
            )
...
if __name__ == "__main__":
    ...
    with open('/app/cms_test_results.json', 'w') as f:
        json.dump(results, f, indent=2, default=str)
    
    print(f"\n📄 Detailed results saved to: /app/cms_test_results.json")